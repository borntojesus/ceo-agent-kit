      ...
      <div className="wrap narrow">
        ...
        <article className="uc" id="search-api">
          ...
          <p className="uc-scenario">
            ...
            витрат, запити не покидають ваш сервер) плюс безкоштовний ключ
            Serper.dev як фолбек, коли потрібна google-якість або українські
            запити. Хто не хоче тримати SearXNG: Tavily з його безкоштовним
            лімітом. Всі ключі зберігаються в 1Password, як і все інше.
          </p>
        </article>
      </div>
    </main>
