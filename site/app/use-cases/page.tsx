    ...
    <main>
      <div className="wrap narrow">
        <div className="page-head">
          ...
          <p className="lead">
            Чотирнадцять сценаріїв з переліком агентів, скілів та інтеграцій:
            десять уже працюють у кіті, чотири позначені «скоро» і зʼявляться
        ...
        <article className="uc" id="search-api">
          ...
          <p className="uc-scenario">
            ...
            спирається лише на памʼять моделі. Таблиця нижче зібрана зі свіжого
            ресерчу (липень 2026): ціни й безкоштовні ліміти в цій категорії
          ...
          <p className="uc-scenario">
            Рекомендація кіта: для ресерчів основний інструмент Tavily
            (кредити оплачує компанія як звичайний робочий сервіс, а починається
            все з безкоштовної тисячі запитів). Для повсякденного пошуку без
            витрат і чужих очей: SearXNG контейнером на тому самому VPS. Ключ
            Serper.dev тримаємо як фолбек для google-видачі та українських
            запитів. Всі ключі зберігаються в 1Password, як і все інше.
          </p>
        </article>
      </div>
    </main>
